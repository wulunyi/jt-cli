...
function createPage(pageName) {
  ...
  try {
    ...
    (0, _log.log)('正在拷贝 wxml 文件');

    _gulp2.default.src(_path2.default.resolve(curPath, '../template/page/tp.wxml')).pipe((0, _gulpRename2.default)({
      basename: pageName,
      extname: '.wxml'
    })).pipe(_gulp2.default.dest(filePath));

    (0, _log.log)('正在拷贝 js 文件');

    _gulp2.default.src(_path2.default.resolve(curPath, '../template/page/tp.js')).pipe((0, _gulpRename2.default)({
      basename: pageName,
      extname: '.js'
    })).pipe(_gulp2.default.dest(filePath));
