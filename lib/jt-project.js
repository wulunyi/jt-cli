...
function createProject(name) {
  ...
  var dependencies = ['wepy', "lodash", 'clone', "promise-polyfill", "wepy-async-function"];

  var devDependencies = ['wepy-compiler-babel', "wepy-compiler-less", "wepy-compiler-pug", "wepy-compiler-sass", "wepy-plugin-imagemin", "wepy-plugin-uglifyjs", 'wepy-plugin-autoprefixer', 'babel-plugin-transform-decorators-legacy', 'babel-plugin-syntax-export-extensions', 'babel-plugin-transform-export-extensions', 'babel-plugin-transform-class-properties', 'babel-plugin-transform-object-rest-spread', 'babel-preset-env', 'cross-env'];
